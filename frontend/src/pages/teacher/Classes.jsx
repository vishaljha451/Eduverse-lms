        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {classes.length > 0 ? classes.map((cls) => (
            <div key={cls._id} className="bg-dark-100 rounded-xl border border-gray-800 overflow-hidden card-hover">
              <div className="h-40 bg-gradient-to-r from-blue-500 to-cyan-500 relative">
                {cls.coverImage && (
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-3 gap-2 pt-4 border-t border-gray-800">
                  <div className="text-center">
                    <FiCheckSquare className="w-5 h-5 mx-auto text-blue-400 mb-1" />
                    <span className="text-xs text-gray-400">Quizzes</span>
                  </div>
                  <div className="text-center">
                    <FiFileText className="w-5 h-5 mx-auto text-green-400 mb-1" />
                    <span className="text-xs text-gray-400">Assignments</span>
                  </div>
                  <div className="text-center">
                    <FiUsers className="w-5 h-5 mx-auto text-purple-400 mb-1" />
